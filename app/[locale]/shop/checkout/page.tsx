  ...
  if (submitted) {
    return (
      <div className="text-center py-20">
        <CheckCircle2 size={64} className="text-[#B5F03D] mx-auto mb-6" />
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <Input
                required
                className="bg-[#2D0A4E] border-white/20 text-white placeholder:text-white/40 focus:border-[#B5F03D]"
              />
            </div>
            <div className="space-y-2">
          ...
          <Button
            type="submit"
            className="bg-[#B5F03D] text-[#1A0530] hover:bg-[#a1d936] font-bold w-full h-12 mt-4"
          >
      ...
      <div>
        ...
        <div className="bg-[#2D0A4E] rounded-2xl p-6 border border-white/10 space-y-4">
          {items.length === 0 ? (
            ...
            <>
              {items.map((item) => (
                <div key={item.id} className="flex gap-3 items-center">
                  ...
                  <p className="text-[#B5F03D] font-bold">{item.price * item.quantity} RON</p>
                </div>
              ))}
    ...
    <CartProvider>
      <div className="min-h-screen bg-[#1A0530]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Link
            href={`/${locale}/shop`}
            className="inline-flex items-center gap-2 text-[#E2D9F3] hover:text-[#B5F03D] transition-colors mb-10 text-sm"
          >
            <ArrowLeft size={16} />
            Back to Shop
          </Link>
